...
<section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        ...
        <img src="{{ $page->url('/assets/img/logo-large.svg') }}" alt="{{ $page->siteName }} large logo" class="mx-auto mb-6 lg:mb-0 ">
    </div>
    ...
    <div class="md:flex -mx-2 -mx-4">
        <div class="mb-8 mx-3 px-2 md:w-1/3">
            <img src="{{ $page->url('/assets/img/icon-window.svg') }}" class="h-12 w-12" alt="window icon">
        ...
        <div class="mb-8 mx-3 px-2 md:w-1/3">
            <img src="{{ $page->url('/assets/img/icon-terminal.svg') }}" class="h-12 w-12" alt="terminal icon">
        ...
        <div class="mx-3 px-2 md:w-1/3">
            <img src="{{ $page->url('/assets/img/icon-stack.svg') }}" class="h-12 w-12" alt="stack icon">
